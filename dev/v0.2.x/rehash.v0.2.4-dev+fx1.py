#!/usr/bin/env python3
# rehash.v0.2.4-dev.py — v0.2.4-dev+fx1
...
#
# Supported CLI:
#   --list / -l           List conversations
#   --conversation / -c   Export one conversation
#   --messages / -m       Extract messages by title/date
...
Version: v0.2.4-dev+fx1
"""

# === Metadata ===
SCRIPT_NAME = "rehash"
SCRIPT_VERSION = "v0.2.4-dev+fx1"
...
def main():
    ...
    parser.add_argument("--list", "-l", action="store_true", help="List conversations")
    parser.add_argument("--conversation", "-c", help="Export single conversation by ID (partial match allowed)")
    parser.add_argument("--messages", "-m", action="store_true", help="Export messages by title/date")
