...
Version: v0.1.1-BUILD1
"""

# === Metadata ===
SCRIPT_NAME = "rehash"
SCRIPT_VERSION = "v0.1.1-BUILD1"
...
def load_conversations(source_path):
    ...
    # Preprocess conversations into enriched metadata objects
    enriched_convos = []
    for convo in data:
        enriched = {
            "id": convo.get("id", ""),
...
def filter_conversations(convos, filter_expr):
    """(Placeholder) Apply jmespath filter - Will be implemented in BUILD 2"""
    return convos

def print_convo_list(convos, mode="trim"):
    """(Placeholder) Print table of conversations - Will be implemented in BUILD 2"""
    pass

def export_convo_list(convos, mode="trim", file_type="csv"):
    """(Placeholder) Export list to CSV/TXT - Will be implemented later"""
    pass
