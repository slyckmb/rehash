...
Version: v0.1.3-BUILD3
"""

# === Metadata ===
SCRIPT_NAME = "rehash"
SCRIPT_VERSION = "v0.1.3-BUILD3"
...
- Path argument comes first (folder or zip file)
- Modifiers like "full", "csv", "tab", "json", "yaml" must be passed as SEPARATE space-separated words.
- Do NOT combine flags and modifiers, e.g., use "-l full" not "-lfull".
- Filters must be passed using the --filter "expression" syntax.
